...
public class DragScaleView extends View implements View.OnTouchListener {
    ...
    protected void initScreenW_H() {
        ...
        //获取图标drawable
        icLeftTop = ContextCompat.getDrawable(getContext(), R.drawable.left_up);
        icRightTop = ContextCompat.getDrawable(getContext(), R.drawable.right_up);

        icLeftBottom = ContextCompat.getDrawable(getContext(), R.drawable.left_down);
        icRightBottom = ContextCompat.getDrawable(getContext(), R.drawable.right_down);
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        borderPaint.setColor(getResources().getColor(R.color.drag_scale_border));
        ...
        //矩形填充
        fillPaint.setColor(getResources().getColor(R.color.drag_scale_bg));
        ...
        //左下角
        icLeftBottom.setBounds(leftBottomRect);
        icLeftBottom.draw(canvas);
        //右下角
        icRightBottom.setBounds(rightBottomRect);
        icRightBottom.draw(canvas);
