...
/**
 * https://www.cnblogs.com/a284628487/p/3367228.html
 */
public class NewDragScaleView extends View implements View.OnTouchListener {
    ...
    public NewDragScaleView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        setOnTouchListener(this);
        initScreenW_H();
    }

    public NewDragScaleView(Context context, AttributeSet attrs) {
        super(context, attrs);
        setOnTouchListener(this);
        initScreenW_H();
    }

    public NewDragScaleView(Context context) {
        super(context);
        setOnTouchListener(this);
        initScreenW_H();
    }
