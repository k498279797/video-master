package com.vxiaokang.video.base.permission;
...
public final class PermissionUtils {
    ...
    public static boolean isNotificationEnable() {
        ...
        String flat = Settings.Secure.getString(App.getContext().getContentResolver(), "enabled_notification_listeners");
        if (flat != null) {
    ...
    public static List<String> getPermissions() {
        return getPermissions(App.getContext().getPackageName());
    }
    ...
    private void startPermissionActivity() {
        ...
        PermissionActivity.start(App.getContext());
    }
