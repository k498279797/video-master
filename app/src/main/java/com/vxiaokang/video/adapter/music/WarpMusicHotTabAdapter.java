package com.vxiaokang.video.adapter.music;
 ...
 * 列表
 */
public class WarpMusicHotTabAdapter extends RecyclerView.Adapter<WarpMusicHotTabAdapter.RecyclerViewHolder> {
    ...
    public WarpMusicHotTabAdapter(Activity activity, List<VideoInfoBean> list, int position) {
     //   Log.d("TAG--",list.size()+"");
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       // Log.d("TAG--","onCreateViewHolder");
        ...
        View view = LayoutInflater.from(mActivity).inflate(R.layout.music_hot_tab_item, null);
