 ...
 * 列表
 */
public class YinshiVideoListDataAdapter extends RecyclerView.Adapter<YinshiVideoListDataAdapter.RecyclerViewHolder> {
    ...
    public YinshiVideoListDataAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
