 ...
 * 列表
 */
public class ShipinVideoDetailAdapter extends RecyclerView.Adapter<ShipinVideoDetailAdapter.RecyclerViewHolder> {
    ...
    public ShipinVideoDetailAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       // Log.d("TAG--","onCreateViewHolder");
        ...
        View view = LayoutInflater.from(mActivity).inflate(R.layout.shipin_video_detail_item, null);
