 ...
 * 列表
 */
public class MusicHotTabAdapter extends RecyclerView.Adapter<MusicHotTabAdapter.RecyclerViewHolder> {
    ...
    public MusicHotTabAdapter(Activity activity, List<VideoInfoBean> list, int position) {
     //   Log.d("TAG--",list.size()+"");
