 ...
 * 列表
 */
public class HuangVideoListDataAdapter extends RecyclerView.Adapter<HuangVideoListDataAdapter.RecyclerViewHolder> {
    ...
    public HuangVideoListDataAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
