 ...
 * 列表
 */
public class MeijuguaVideoDetailAdapter extends RecyclerView.Adapter<MeijuguaVideoDetailAdapter.RecyclerViewHolder> {
    ...
    public MeijuguaVideoDetailAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
