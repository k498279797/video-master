 ...
 * 列表
 */
public class ClassListDataAdapter extends RecyclerView.Adapter<ClassListDataAdapter.RecyclerViewHolder> {
    ...
    public ClassListDataAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
