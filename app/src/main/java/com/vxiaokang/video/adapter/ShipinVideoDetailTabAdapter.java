 ...
 * 列表
 */
public class ShipinVideoDetailTabAdapter extends RecyclerView.Adapter<ShipinVideoDetailTabAdapter.RecyclerViewHolder> {
    ...
    public ShipinVideoDetailTabAdapter(Activity activity, List<String> list,int position) {
     //   Log.d("TAG--",list.size()+"");
