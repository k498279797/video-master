 ...
 * 列表
 */
public class KantvVideoDetailAdapter extends RecyclerView.Adapter<KantvVideoDetailAdapter.RecyclerViewHolder> {
    ...
    public KantvVideoDetailAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
