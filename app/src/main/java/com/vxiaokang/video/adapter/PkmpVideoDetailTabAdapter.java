 ...
 * 列表
 */
public class PkmpVideoDetailTabAdapter extends RecyclerView.Adapter<PkmpVideoDetailTabAdapter.RecyclerViewHolder> {
    ...
    public PkmpVideoDetailTabAdapter(Activity activity, List<String> list, int position) {
     //   Log.d("TAG--",list.size()+"");
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       // Log.d("TAG--","onCreateViewHolder");
        ...
        View view = LayoutInflater.from(mActivity).inflate(R.layout.pkmp_video_detail_tab_item, null);
