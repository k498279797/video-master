 ...
 * 列表
 */
public class HuangCateVideoChildAdapter extends RecyclerView.Adapter<HuangCateVideoChildAdapter.RecyclerViewHolder> {
    ...
    public HuangCateVideoChildAdapter(Activity activity, List<VideoInfoBean> list, int parentPositon) {
        //Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(mActivity).inflate(R.layout.huang_cate_child_video_item, null);
