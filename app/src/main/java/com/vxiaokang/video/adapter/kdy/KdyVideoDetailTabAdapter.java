 ...
 * 列表
 */
public class KdyVideoDetailTabAdapter extends RecyclerView.Adapter<KdyVideoDetailTabAdapter.RecyclerViewHolder> {
    ...
    public KdyVideoDetailTabAdapter(Activity activity, List<String> list, int position) {
     //   Log.d("TAG--",list.size()+"");
