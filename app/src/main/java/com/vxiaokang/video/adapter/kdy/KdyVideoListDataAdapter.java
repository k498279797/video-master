 ...
 * 列表
 */
public class KdyVideoListDataAdapter extends RecyclerView.Adapter<KdyVideoListDataAdapter.RecyclerViewHolder> {
    ...
    public KdyVideoListDataAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
