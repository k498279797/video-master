 ...
 * 列表
 */
public class KantvVideoDetailTabAdapter extends RecyclerView.Adapter<KantvVideoDetailTabAdapter.RecyclerViewHolder> {
    ...
    public KantvVideoDetailTabAdapter(Activity activity, List<String> list, int position) {
     //   Log.d("TAG--",list.size()+"");
