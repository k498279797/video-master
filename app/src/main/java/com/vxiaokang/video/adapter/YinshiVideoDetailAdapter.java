 ...
 * 列表
 */
public class YinshiVideoDetailAdapter extends RecyclerView.Adapter<YinshiVideoDetailAdapter.RecyclerViewHolder> {
    ...
    public YinshiVideoDetailAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
