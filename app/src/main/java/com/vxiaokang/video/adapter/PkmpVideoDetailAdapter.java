 ...
 * 列表
 */
public class PkmpVideoDetailAdapter extends RecyclerView.Adapter<PkmpVideoDetailAdapter.RecyclerViewHolder> {
    ...
    public PkmpVideoDetailAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       // Log.d("TAG--","onCreateViewHolder");
        ...
        View view = LayoutInflater.from(mActivity).inflate(R.layout.pkmp_video_detail_item, null);
