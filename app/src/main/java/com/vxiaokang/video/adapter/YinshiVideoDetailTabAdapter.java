 ...
 * 列表
 */
public class YinshiVideoDetailTabAdapter extends RecyclerView.Adapter<YinshiVideoDetailTabAdapter.RecyclerViewHolder> {
    ...
    public YinshiVideoDetailTabAdapter(Activity activity, List<String> list, int position) {
     //   Log.d("TAG--",list.size()+"");
