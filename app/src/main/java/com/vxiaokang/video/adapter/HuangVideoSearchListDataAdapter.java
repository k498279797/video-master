 ...
 * 列表
 */
public class HuangVideoSearchListDataAdapter extends RecyclerView.Adapter<HuangVideoSearchListDataAdapter.RecyclerViewHolder> {
    ...
    public HuangVideoSearchListDataAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
    ...
    public RecyclerViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
       // Log.d("TAG--","onCreateViewHolder");
        ...
        View view = LayoutInflater.from(mActivity).inflate(R.layout.huang_video_item, null);
