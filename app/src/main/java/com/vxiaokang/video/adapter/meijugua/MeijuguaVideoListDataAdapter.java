 ...
 * 列表
 */
public class MeijuguaVideoListDataAdapter extends RecyclerView.Adapter<MeijuguaVideoListDataAdapter.RecyclerViewHolder> {
    ...
    public MeijuguaVideoListDataAdapter(Activity activity, List<VideoInfoBean> list) {
     //   Log.d("TAG--",list.size()+"");
        mActivity = activity;
        mList = list;
    }
