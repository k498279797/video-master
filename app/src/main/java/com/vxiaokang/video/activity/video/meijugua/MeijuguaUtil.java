 ...
 * @Description:
 */
public class MeijuguaUtil {
    private static final String TAG = "MeijuguaUtil";
    ...
    //自定义监听
    public interface MeijuguaListener{
    ...
    /**
     * 请求更新链接 http://www.meijugua.com
     *  https://www.1080kdy.com/index.php/vod/detail/id/100284.html
     */
    public static void getUrl(String url,MeijuguaListener listener){
        try {
