 ...
 * 详情页面
 */
public class KantvVideoDetailActivity extends AppCompatActivity implements View.OnClickListener{
       ...
       // GridLayoutManager gridLayoutManager2 = new GridLayoutManager(this, 5);
        ...
        classAdapter.setOnItemClickListener(position -> {
            try{
                ...
                Intent intent = new Intent(this, KantvVideoDetailPlayActivity.class);
