 ...
 * 详情页面
 */
public class YinshiVideoDetailActivity extends AppCompatActivity implements View.OnClickListener{
    private String TAG = "YinshiVideoDetailActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yinshi_video_detail);
    ...
    private void initView() {
      ...
      //  String  title = getIntent().getStringExtra("title");
        ...
        tabAdapter = new YinshiVideoDetailTabAdapter(this,tabList,0);
      ...
      //  GridLayoutManager gridLayoutManager = new GridLayoutManager(this, 5);
        ...
        classAdapter.setOnItemClickListener(position -> {
            try{
                ...
                Intent intent = new Intent(this, YinshiVideoDetailPlayActivity.class);
        ...
        try{
            new Thread(() -> {
                ...
                try{
                    ...
                    String img = document.select("a.pic img").first().attr("data-original");
                  ...
                  //  System.out.println(img);
                    Elements tabs = document.select("ul.nav-tabs li");
