 ...
 * 列表
 */
public class DudeVideoListActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String categoryId = "/popular/";
    ...
    private void initSpinnerRegion(){
        String[] tabName = DudeConstant.regionName;
        //声明一个下拉列表的数组适配器
        ...
        regionSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                searchRegion = DudeConstant.regionId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerType(){
        String[] tabName = DudeConstant.typeName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        typeSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                searchType = DudeConstant.typeId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerLanguage(){
        String[] tabName = DudeConstant.languageName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        languageSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                searchLanguage = DudeConstant.languageId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerTab(){
        String[] tabName = DudeConstant.tabName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        tabSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                categoryId = DudeConstant.tabId[position]+"";
                pageIndex = 1;
                if(initFlag){
                    setDataList();
                }
    ...
    private void initSpinnerYear(){
        String[] tabName = DudeConstant.yearName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        yearSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
               String  routLine = DudeConstant.yearId[position]+"";
               if(!StringUtils.isEmpty(routLine)){
                   DudeConstant.setReqDomain(routLine);
               }
                if(initFlag){
                    setDataList();
                }
    ...
    private void initSpinnerOrder(){
        String[] tabName = DudeConstant.orderName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        orderSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                orderBy = DudeConstant.orderId[position]+"";
                if(initFlag){
                    pageIndex = 1;
                    searchword = "";
                    setDataList();
    ...
    private void initView() {
        ...
        if(!TextUtils.isEmpty(tabName)){
            ...
            for(int i = 0; i < DudeConstant.tabName.length ; i++){
                if(StringUtils.equals(tabName, DudeConstant.tabName[i])){
        ...
        classAdapter.setOnItemClickListener(position -> {
            try{
                ...
                Intent intent = new Intent(this, DudeVideoDetailPlayActivity.class);
    ...
    private void setDataList() {
        try{
            ...
            new Thread(() -> {
                ...
                if(pageIndex > 1){
                    // https://gaydude.me/popular/2/
                    apiUrl = DudeConstant.getReqDomain() +"%s"+"%s/";
                    apiUrl = String.format(apiUrl,categoryId,pageIndex);
                }else{
                    apiUrl = DudeConstant.getReqDomain() +"%s";
