 ...
 * 详情页面
 */
public class GaytubeVideoDetailActivity extends AppCompatActivity implements View.OnClickListener{
    private String TAG = "GaytubeVideoDetailActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_kdy_video_detail);
    ...
    private void initView() {
      ...
      //  String  title = getIntent().getStringExtra("title");
        ...
        tabAdapter = new KdyVideoDetailTabAdapter(this,tabList,0);
        tabRecView.setLayoutManager(gridLayoutManager2);
        ...
        classAdapter.setOnItemClickListener(position -> {
            try{
                ...
                Intent intent = new Intent(this, KdyVideoDetailPlayActivity.class);
        ...
        try{
            new Thread(() -> {
                ...
                try{
                    ...
                    String name = document.select("h1.title").first().text();
                    String desc = document.select("span.content").first().text();
                  ...
                  //  System.out.println(img);
                   // Element panelHead = document.select(".myui-panel__head").first();
                    Elements tabs = document.select("ul.nav-tabs").first().select("a");
                    ...
                    for(Element itElement : elements) {
                        ...
                        for(Element info : aElements) {
                            ...
                            infoBean.setLink(KdyConstant.getReqDomain()+info.attr("href"));
