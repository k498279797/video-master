 ...
 * 详情页面
 */
public class HdtvVideoDetailActivity extends AppCompatActivity implements View.OnClickListener{
    private String TAG = "HdtvVideoDetailActivity";
       ...
       // GridLayoutManager gridLayoutManager2 = new GridLayoutManager(this, 5);
        ...
        classAdapter.setOnItemClickListener(position -> {
            try{
                ...
                Intent intent = new Intent(this, HdtvVideoDetailPlayActivity.class);
        ...
        try{
            new Thread(() -> {
                ...
                try{
                    ...
                    String img = document.select("div.mb img").first().attr("src");
                    String name = document.select("div.mb .ct-c h1").first().text();
                    String desc = document.select("div.mb .ee").first().text();
                    Elements dlall = document.select("div.mb .ct-c dt");
                    for(Element itElement : dlall) {
                        tagsTemp.add(itElement.text());
                    }
                    dlall = document.select("div.mb .ct-c dd");
                    for(Element itElement : dlall) {
                        tagsTemp.add(itElement.text());
