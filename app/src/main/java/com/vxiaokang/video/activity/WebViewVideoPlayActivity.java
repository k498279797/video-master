...
import com.vxiaokang.video.view.VideoEditor;
 ...
 * web view
 */
public class WebViewVideoPlayActivity extends AppCompatActivity implements View.OnClickListener {
    private String TAG = "WebViewVideoPlayActivity";
    ...
    private void setData(String url) {
       ...
       // String url = "https://vod3.bdzybf7.com/20221119/FnZBvgl2/index.m3u8";
        String content = "<video  class=\"video-js vjs-default-skin vjs-big-play-centered\" controls preload=\"auto\" width=\"350\" height=\"280\" data-setup='{}'>\n" +
                "        <source src=\"%s\" type=\"application/x-mpegURL\">\n" +
                "    </video>";
        //webCommonView.setHtml(String.format(content,url));
        String path = "file:///android_asset/video_play.html?url="+url;
       webCommonView.loadUrl(url);
        //webCommonView.loadUrl(path);
    }
    ...
    public class myWebChromeClient extends WebChromeClient {
        ...
        public void onShowCustomView(View view, CustomViewCallback callback) {
            ...
            StatusBarUtil.hideBottomUIMenu(WebViewVideoPlayActivity.this);
        }
        ...
        public void onHideCustomView() {
            ...
            StatusBarUtil.setNavbarColor(WebViewVideoPlayActivity.this);
        }
        ...
        public View getVideoLoadingProgressView() {
            if (xprogressvideo == null) {
                LayoutInflater inflater = LayoutInflater
                        .from(WebViewVideoPlayActivity.this);
