 ...
 * 详情页面
 */
public class ShipinVideoDetailActivity extends AppCompatActivity implements View.OnClickListener{
    private String TAG = "ShipinVideoDetailActivity";
    ...
    private void initView() {
      ...
      //  String  title = getIntent().getStringExtra("title");
       ...
       // GridLayoutManager gridLayoutManager2 = new GridLayoutManager(this, 5);
        ...
        tabAdapter = new ShipinVideoDetailTabAdapter(this,tabList,0);
        ...
        classAdapter.setOnItemClickListener(position -> {
            try{
                ...
                Intent intent = new Intent(this, ShipinVideoDetailPlayActivity.class);
        ...
        try{
            new Thread(() -> {
                ...
                try{
                    ...
                    String img = document.select(".dpic").first().attr("src");
                    String name = document.select("p.name").first().text();
                    Elements dlall = document.select(".dlall .dl dl");
    ...
    private void updateUI(VideoInfoBean info){
        if(null != info){
            if(!this.isDestroyed()){
                if(!this.isDestroyed()) {
                    /*lide.with(this).load(info.getCoverImage()).placeholder(R.mipmap.error)
