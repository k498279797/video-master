...
import com.vxiaokang.video.activity.video.yinshi.bean.YinshiConstant;
import com.vxiaokang.video.adapter.YinshiVideoListDataAdapter;
 ...
 * 列表
 */
public class YinshiVideoListActivity extends AppCompatActivity implements View.OnClickListener{
    private String TAG = "YinshiVideoListActivity";
    ...
    private YinshiVideoListDataAdapter classAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_yinshi_video_list);
    ...
    private void initSpinnerRegion(){
        String[] tabName = YinshiConstant.regionName;
        //声明一个下拉列表的数组适配器
        ...
        regionSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                searchRegion = YinshiConstant.regionId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerType(){
        String[] tabName = YinshiConstant.typeName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        typeSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                searchType = YinshiConstant.typeId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerLanguage(){
        String[] tabName = YinshiConstant.languageName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        languageSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                searchLanguage = YinshiConstant.languageId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerTab(){
        String[] tabName = YinshiConstant.tabName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        tabSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                categoryId = YinshiConstant.tabId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerYear(){
        String[] tabName = YinshiConstant.yearName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        yearSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                searchYear = YinshiConstant.yearId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initSpinnerOrder(){
        String[] tabName = YinshiConstant.orderName;
        //声明一个下拉列表的数组适配器
        ArrayAdapter<String> starAdapter = new ArrayAdapter<String>(this,R.layout.item_select,tabName);
        //设置数组适配器的布局样式
        starAdapter.setDropDownViewResource(R.layout.item_dropdown);
        ...
        orderSp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                orderBy = YinshiConstant.orderId[position]+"";
                if(initFlag){
                    setDataList();
                }
            }
    ...
    private void initView() {
        ...
        if(!TextUtils.isEmpty(tabName)){
            ...
            for(int i = 0 ; i < YinshiConstant.tabName.length ; i++){
                if(StringUtils.equals(tabName,YinshiConstant.tabName[i])){
        ...
        classAdapter = new YinshiVideoListDataAdapter(this,videoInfoList);
        ...
        classAdapter.setOnItemClickListener(position -> {
            try{
                Intent intent = new Intent(this, YinshiVideoDetailActivity.class);
        ...
        try{
            ...
            new Thread(() -> {
                ...
                if(StringUtils.isEmpty(searchword)){
                    apiUrl = YinshiConstant.getReqDomain() +"/search.php?searchtype=5&tid=%s&area=%s&order=%s&jq=%s&yuyan=%s&page=%s&year=%s";
                    ...
                    apiUrl = YinshiConstant.getReqDomain() +"/search.php?searchtype=&tid=%s&area=%s&order=%s&jq=%s&yuyan=%s&page=%s&year=%s&searchword=%s";
                ...
                try{
                    ...
                    for(Element element: elements) {
                        ...
                        System.out.println();*/
                        info.setTitle(name);
                        info.setLink(YinshiConstant.getReqDomain()+link);
                        ...
                        if(!StringUtils.isEmpty(img)){
                            if(img.startsWith("http")){
                                ...
                                info.setCoverImage(YinshiConstant.getReqDomain()+img);
                            }
                        }
