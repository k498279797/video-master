 ...
 *
 * @CLASS: https://www.94kan.cc 获取视频地址
 * @Date: 2022/04/19/17:32
 * @Description:
 */
public class KanccUtil {
    private static final String TAG = "KanccUtil";
    ...
    //自定义监听
    public interface KanccListener{
    ...
    /**
     * 请求更新链接
     *  https://www.94kan.cc/dongmanplay/90174-1-1.html
     */
    public static void getUrl(String url,KanccListener listener){
        try {
