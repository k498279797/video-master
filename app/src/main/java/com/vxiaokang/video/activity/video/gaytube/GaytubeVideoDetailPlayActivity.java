 ...
 * 详情列表
 */
public class GaytubeVideoDetailPlayActivity extends AppCompatActivity implements View.OnClickListener{
        ...
        try{
            if(position>=0 && null != videoInfoList && videoInfoList.size()-1>= position){
               ...
               // if(StringUtils.isEmpty(videoInfoBean.getLink())){
                GaytubeUtil.getUrl(videoInfoBean.getLink(), new GaytubeUtil.GaytubeListener() {
                        @Override
